...
|-------|------|----------|--------|------|
| 1 | `00_data_cleaning.py` | §I.A-B Data | `01_crsp_clean`, `02_compustat_clean`, `03_ff_factors` | ✅ |
| 2+3 | `01_alignment_merge.py` | §I.A-B Data | `04_merged_features`, `04_crsp_monthly` | ✅ |
| 4 | `03_beta_estimation.py` | §I.C Portfolios | `05_beta_assigned`, `05_port_returns`, `05_sum_betas` | ✅ |
| 5~8 | `04_portfolio_analysis.py` | §II-V | `06_table2/3_results` | ✅ |
...
> [!NOTE]
> CUSIP6 매핑 성공률이 70.6%로 경계선이다. CCM 링크 테이블을 사용하면 매핑률이 90%+로 개선되어 논문 수치에 더 근접할 수 있다.
...
| 한계 | 영향 | 보완 방안 |
|------|------|----------|
| CUSIP6 매핑 (70.6%) | 30%의 Compustat 기업이 CRSP와 미연결 → 샘플 축소 | CCM 링크 테이블 사용 시 90%+ |
